...
import LogoCarCare from './media/LogoCarCare.png';
import CarCare from './media/CarCare.png';
import pdp from './media/def.png';
import experte from './media/experte.png';
import McCarthysCarsWomanKey from './media/McCarthys_Cars_Woman_Key.png';

class Motorist extends React.Component {
  constructor(props) {
    super(props);
    this.state = {motoristAccount: [],
                  motoristPicture: [],
                  motoristVehicles: [],
                  motoristBookings: [],
                  motoristControls: 0};
      ...
      <div className={"carousel-item "+active}>
        <div className="card">
          <div className="card-body">
            <img className="img-thumbnail rounded-circle" src={pdp} alt="Card image cap"/>
...
class MotoristCarousel extends React.Component {
  render() {
    var rows = [];
    var active = true;
...
class MotoristCarouselApp extends React.Component {
...
class Tvg extends React.Component {

  constructor(props) {
    super(props);
    this.state = {tvgAccount: [],
                  tvgPicture: [],
                  tvgEmployees: [],
                  tvgBookings: [],
                  tvgControls: []};
...
class TvgCarousel extends React.Component {
  render() {
    var rows = [];
    var active = true;
...
class TvgCarouselApp extends React.Component {
...
class TvgTable extends React.Component {
  render() {
...
class TvgApp extends React.Component {
  loadTvgsFromServer() {
    var self = this;
    $.ajax({
      url: "http://localhost:8080/api/tvgs"
...
class Header extends React.Component {
  constructor(props) {
    super(props);
    this.state = {  scrollBackground: 'nav-bg', logo: LogoCarCare, id: 'navbar-brand-logocarcare' };
    this.handleScroll = this.handleScroll.bind(this);
  }
  componentWillMount() {
    let scrollTop = window.pageYOffset,
        backgroundValue = (scrollTop != 0) ? "nav-bg-shadow" : "nav-bg",
        logoValue = (scrollTop != 0) ? CarCare : LogoCarCare,
      ...
      <section className="secondsection row">
        ...
        <div className="rightsecondsection col row">
          ...
          <div className="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <img src={experte} alt="Card image cap"/>
          </div>
        </div>
      </section>
    );
    ...
    return (
      <section className="thirdsection row">
        <div className="leftthirdsection col row">
          <div className="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <img src={McCarthysCarsWomanKey} alt="Card image cap"/>
          </div>
          <div className="col Aligner">
